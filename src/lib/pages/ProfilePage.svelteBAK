  ...
  $: profileStats = [
    {
      ...
      value: Math.floor(
        (new Date().getTime() - new Date(profile.joinDate).getTime()) /
          (1000 * 60 * 60 * 24),
      ).toString(),
...
<div class="space-y-6">
  ...
  >
    <div
      class="card bg-base-100 shadow-md border border-base-300 hover:shadow-lg hover:scale-[1.02] transition-all duration-200"
      use:motionHover
    >
      <div class="card-body p-4">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div
              class="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center shadow-sm"
            >
    ...
    >
      <div class="card-body p-4">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div
              class="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center shadow-sm"
            >
    ...
    >
      <div class="card-body p-4">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div
              class="w-12 h-12 bg-purple-500 rounded-lg flex items-center justify-center shadow-sm"
            >
              <Icon
                icon="heroicons:clipboard-document-check"
    ...
    >
      <div class="card-body p-4">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div
              class="w-12 h-12 bg-orange-500 rounded-lg flex items-center justify-center shadow-sm"
            >
        ...
        <div class="card-body">
          <div class="flex items-center justify-between mb-6">
            <h2 class="card-title text-xl flex items-center">
              <div
                class="w-8 h-8 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg flex items-center justify-center mr-3"
              >
          ...
          <div class="flex items-center justify-between mb-6">
            <h2 class="card-title text-xl flex items-center">
              <div
                class="w-8 h-8 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg flex items-center justify-center mr-3"
              >
                <Icon icon="heroicons:photo" class="w-4 h-4 text-primary" />
              </div>
              {$_("profile.gallery_information")}
            </h2>
            {#if isEditing}
              <button
                class="btn btn-sm btn-outline hover:bg-error hover:text-white transition-all duration-200"
      ...
      >
        <div class="card-body text-center">
          <div class="relative inline-block">
            <div class="avatar">
              <div
                class="w-24 rounded-full ring-4 ring-primary/20 ring-offset-base-100 ring-offset-2 shadow-lg"
              >
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center space-x-3">
              <div
                class="w-8 h-8 bg-gradient-to-br from-accent/20 to-secondary/20 rounded-lg flex items-center justify-center"
              >
                <Icon icon="heroicons:clock" class="w-4 h-4 text-accent" />
              </div>
              <div class="text-left">
                <p class="text-sm font-medium text-base-content">
                  {$_("profile.last_active")}
                </p>
                <p class="text-sm text-base-content/60">
                  {formatTime(profile.lastActive)}
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div class="card-body">
              <h2 class="card-title text-xl mb-6 flex items-center">
                <div
                  class="w-8 h-8 bg-gradient-to-br from-accent/20 to-secondary/20 rounded-lg flex items-center justify-center mr-3"
                >
                  <Icon
                        ...
                        <div class="form-control">
                          <div class="flex items-center space-x-2">
                            ...
                            <button
                              ...
                              on:click={() =>
                                (editForm.skills = editForm.skills.filter(
                                  (_, i) => i !== index,
                                ))}
                            >
                  ...
                  {#if isEditing}
                    <div class="space-y-2">
                      ...
                      <button
                        class="btn btn-sm btn-outline"
                        on:click={() =>
                          (editForm.languages = [...editForm.languages, ""])}
                      >
                        <Icon icon="heroicons:plus" class="w-4 h-4 mr-1" />
